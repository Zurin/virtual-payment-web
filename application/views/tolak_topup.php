    ...
    <div class="box box-danger">
      <div class="box-body box-profile">
        <h3 class="profile-username text-center">
          Apakah Anda yakin akan menolak top up dengan data di bawah ini?
        </h3>
        ...
        <center>
          <a href="<?php echo base_url(); ?>admin/tolak_proses/<?php echo $member."/".$topup ?>" class="btn btn-primary"><b>Ya</b></a>
